...
# Form implementation generated from reading ui file 'NvInterface.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        label.setText('Choisissez un fichier wav')
        self.centralwidget.setWindowTitle('Label')
        self.centralwidget.setGeometry(QtCore.QRect(310, 110, 211, 121))
        label.move(300, 200)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(370, 250, 101, 41))
...
"background-color: rgb(255, 255, 255);")
    ...
    def open_dialog_box(self):
        ...
        return self.pushButton_2.clicked.connect(self.mod_wind(filename[0]))
    
    def mod_wind(self,text):
        genre=self.update_prediction(text)
        MainWindow.setObjectName("Genre Window")
